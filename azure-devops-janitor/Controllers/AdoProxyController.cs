using azure_devops_janitor.Models.Ado;
...
namespace azure_devops_janitor.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class AdoProxyController : ControllerBase
    {
        ...
        public async Task Callback([FromQuery] string code, [FromQuery] string state) 
        {
            ...
            var adoProfile = JsonSerializer.Deserialize<Profile>(adoProfileData);
